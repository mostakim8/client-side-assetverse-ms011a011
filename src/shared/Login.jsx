...
const Login = () => {
  ...
  const onSubmit = async (data) => {
    setLoading(true); // লগইন শুরু হলে লোডিং ট্রু
    try {
        ...
        <div className="w-full lg:w-1/2 p-8 md:p-14 flex flex-col justify-center">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading} // 
              className="w-full bg-[#1B1A55] hover:bg-[#535C91] text-white py-3 rounded-2xl font-black text-[11px] tracking-[0.3em] transition-all shadow-xl shadow-[#1B1A55]/20 active:scale-95 mt-2 cursor-pointer flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-white dark:bg-[#070F2B] border border-gray-100 dark:border-[#535C91]/30 py-3 rounded-2xl font-black text-[10px] tracking-widest text-[#070F2B] dark:text-white hover:bg-gray-50 dark:hover:bg-[#1B1A55]/40 transition-all active:scale-95 shadow-sm cursor-pointer"
          >
            <img
              className="w-5"
